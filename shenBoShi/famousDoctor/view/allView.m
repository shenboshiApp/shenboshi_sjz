...
//        for (NSString *str in fullNameArray) {
//            NSLog(@"%@",str);
//        }
        [self bottomView];
...
-(void)createTableView{
    ...
    _tableView=[[UITableView alloc]initWithFrame:CGRectMake(0, 0, KDEVICEWIDTH, KDEVICEHEIGHT - 92) style:UITableViewStylePlain];
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if(!cell){
        ...
        UIImageView *imageView = [[UIImageView alloc] initWithFrame:CGRectMake(14, 10, 14, 14)];
        
       int arcNumber = arc4random()%(3 - 1 + 1) + 1;
        
        [imageView setImage:[UIImage imageNamed:[NSString stringWithFormat:@"%d",arcNumber]]];
        ...
        UILabel *nameLabel = [[UILabel alloc] initWithFrame:CGRectMake(38, 10, KDEVICEWIDTH - 12 - 38, 12)];
        ...
        UILabel *detailLabel = [[UILabel alloc] initWithFrame:CGRectMake(38, 31, KDEVICEWIDTH - 12 - 38, 41)];
