...
-(void)createTableView{
    ...
    _tableView=[[UITableView alloc]initWithFrame:CGRectMake(0, 0, KDEVICEWIDTH, KDEVICEHEIGHT - 93) style:UITableViewStylePlain];
...
{
    consultDetailController * consultDetail=[[consultDetailController alloc]init];
    consultDetail.string =[NSString stringWithFormat:@"%@    %@",fullNameArray[indexPath.row],diseaseArray[indexPath.row]];
    consultDetail.symString=diseaseDetailArray[indexPath.row];
    [self.viewController.navigationController pushViewController:consultDetail animated:YES ];
