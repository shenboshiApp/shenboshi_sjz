...
//             temp.frame=CGRectMake(10+i*((screen_width-10*(self.xl_buttonNames.count+1))/self.xl_buttonNames.count+10), 0, (screen_width-10*(self.xl_buttonNames.count+1))/self.xl_buttonNames.count, self.xl_topHeight?self.xl_topHeight:50);
//            
//             [temp setBackgroundImage:[UIImage imageNamed:@"chat_send_button"] forState:UIControlStateNormal];
...
-(void)changed:(UIButton *)button{
    ...
    if (self.xl_buttonNames.count <=5) {
        ...
        if (button.center.x > button.bounds.size.width*2) {
            self.scroll2.contentOffset =CGPointMake((button.center.x)*self.xl_buttonNames.count 
        ...
        }else if(button.center.x > button.bounds.size.width && button.center.x < button.bounds.size.width *2){
            self.scroll2.contentOffset =CGPointMake((button.center.x)*self.xl_buttonNames.count
        ...
        }else if (button.center.x < button.bounds.size.width && button.center.x > 0){
            self.scroll2.contentOffset =CGPointMake((button.center.x)*self.xl_buttonNames.count
